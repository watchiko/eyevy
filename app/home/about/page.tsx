  ...
  return (
    <>
      <div className="bg-neutral-900 text-white p-8 font-sans">
        <div className="mb-8 min-h-screen flex flex-col justify-center max-w-[50vw]">
        ...
        <div className="mb-8 min-h-screen flex flex-col justify-center max-w-[50vw]">
          ...
          <ul className="list-disc pl-4 text-lg list-inside leading-loose">
        ...
        <div className="mb-8 min-h-screen flex flex-col justify-center max-w-[50vw]">
          ...
          <p className="text-lg leading-loose">Watchiko is built as a modular four-tier system:</p>
        ...
        <div className="mb-8 min-h-screen flex flex-col justify-center max-w-[50vw]">
          ...
          <p className="text-lg leading-loose">Watchiko is built with a strong emphasis on:</p>
          <ul className="list-disc pl-4 text-lg list-inside leading-loose">
